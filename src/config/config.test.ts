...
describe('Config', () => {
  ...
  it('should load default config', () => {
    ...
    expect(config.unityBridgeDiscoveryEnabled).toBe(true);
    expect(config.unityBridgeDiscoveryTtlMs).toBe(20000);
  ...
  it('should override via environment variables', () => {
    ...
    process.env.UNITY_BRIDGE_INSTANCE_ID = 'arrow-editor';
    ...
    expect(config.unityBridgeInstanceId).toBe('arrow-editor');
